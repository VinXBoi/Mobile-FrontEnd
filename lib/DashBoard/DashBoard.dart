                ...
                children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () async {
                          ...
                          if (result != null && result.isNotEmpty) {
                            goalsProvider.addGoal(widget.username, widget.dashboard, result);
                          }
                        },
                      ),
                    ],
                  ...
                  ReorderableListView(
                    ...
                    onReorder: (oldIndex, newIndex) {
                      goalsProvider.reorderGoals(widget.username, widget.dashboard, oldIndex, newIndex);
                    },
                    children: [
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final controller = TextEditingController(text: goals[i]);
                                    final result = await showDialog<String>(
                                      context: context,
                                      builder: (context) => AlertDialog(
                                    ...
                                    if (result != null && result.isNotEmpty) {
                                      goalsProvider.editGoal(widget.username, widget.dashboard, i, result);
                                    }
                                  },
                                ),
                                IconButton(
                                  icon: Icon(Icons.delete, size: 20),
                                  onPressed: () => goalsProvider.removeGoal(widget.username, widget.dashboard, i),
                                ),
